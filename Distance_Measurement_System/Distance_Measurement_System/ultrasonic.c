...
{
	/* ICU configured with frequency F_CPU/8 and to detect the raising edge as the first edge. */
	ICU_ConfigType ICU_Configurations = {F_CPU_8,RISING};
	ICU_init(&ICU_Configurations);

	/* setup trigger pin direction as output pin using GPIO driver */
	GPIO_setupPinDirection(ULTRASONIC_TRIGGER_PORT_ID,ULTRASONIC_TRIGGER_PIN_ID,PIN_OUTPUT);

	/* setting ICU call back function using Ultrasonic_edgeProcessing function */
